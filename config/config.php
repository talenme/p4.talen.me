...
# What is the name of this app?
	define('APP_NAME', 'Flash Cards');  

# When email is sent out from the server, where should it come from?
# Ideally, this should match the domain name
	define('APP_EMAIL', 'webmaster@talen.me'); 
...
*/ 	
	define('SYSTEM_EMAIL', 'gregmmail@gmail.com'); 

# Default DB name for this app
	define('DB_NAME', 'talenme_p4_talen_me'); 
...
# For extra security, you might want to set different salts than what the core uses
	define('PASSWORD_SALT', 'T6nSp7w1Ylv5lx01hOWH5MeC4tJQdWHD0VAUEBmS');
	define('TOKEN_SALT', 'mQwo8sBiwaiTIBbzfS7WdihbuHbTdCTvTnxouUDx');